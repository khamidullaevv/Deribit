...
class PriceModelTestCase(TestCase):
    ...
    def test_price_creation(self):
        """Test that price is created correctly."""
    ...
    def test_price_ticker_choices(self):
        """Test that only valid tickers are accepted."""
...
class PriceServiceTestCase(TestCase):
    ...
    def test_get_latest_price_empty(self):
        """Test that None is returned for non-existent ticker."""
        latest = self.service.get_latest_price('btc_usd')
        self.assertIsNone(latest)
    
    def test_get_prices_by_date_range(self):
        """Test retrieving prices by date range."""
        # Create prices spanning 10 seconds
        for i in range(10):
            Price.objects.create(
                ticker='btc_usd',
                price=Decimal('50000.00'),
        ...
        self.assertEqual(prices.count(), 6)  # 2, 3, 4, 5, 6, 7
...
class PriceAPITestCase(TestCase):
    ...
    def test_all_prices_missing_ticker(self):
        """Test that missing ticker parameter returns error."""
    ...
    def test_latest_price_endpoint(self):
        """Test /api/prices/latest/ endpoint."""
    ...
    def test_date_range_endpoint(self):
        """Test /api/prices/range/ endpoint."""
    ...
    def test_date_range_invalid_dates(self):
        """Test that invalid date order returns error."""
